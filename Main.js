                ...
                do{
                    ...
                    switch(filtro){
                        case 1:
                            ...
                            do{
                                atleta = prompt("Nome atleta di cui visualizzare i piazzamenti sul podio (dentro e fuori) per ogni gara: ");
                                ctrl = u.Check_Atleta(registro_atleti, atleta);
                                if(!ctrl)
                        ...
                        case 2:
                            ...
                            do{
                                atleta_2 = prompt("Nome atleta di cui visualizzare i piazzamenti sul podio (dentro e fuori) per ogni gara: ");
                                controllo = u.Check_Atleta(registro_atleti, atleta_2);
                                if(!controllo)
                                    console.log("Inserire il nome di un atleta presente nel registro.");
                            }while(!controllo);
